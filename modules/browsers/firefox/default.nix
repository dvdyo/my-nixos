  ...
  config = mkIf cfg.enable {
    programs.firefox = {
      ...
      policies = {
        ...
        #     Homepage.StartPage = "previous-session"; stinky bug causer on niri
        UserMessaging = {
          SkipOnboarding = true;
        ...
        ExtensionSettings = {
          ...
          "gdpr@cavi.au.dk".install_url =
            "https://addons.mozilla.org/en-US/firefox/downloads/latest/consent-o-matic/latest.xpi";
          "sponsorBlocker@ajay.app".installation_mode = "force_installed";
          "sponsorBlocker@ajay.app".install_url =
            "https://addons.mozilla.org/en-US/firefox/downloads/latest/sponsorblock/latest.xpi";
          "redirector@einaregilsson.com".installation_mode = "force_installed";
          "redirector@einaregilsson.com".install_url =
            "https://addons.mozilla.org/en-US/firefox/downloads/latest/redirector/latest.xpi";
          "jid0-3GUEt1r69sQNSrca5p8kx9Ezc3U@jetpack".installation_mode = "force_installed";
          "jid0-3GUEt1r69sQNSrca5p8kx9Ezc3U@jetpack".install_url =
            "https://addons.mozilla.org/en-US/firefox/downloads/latest/terms-of-service-didnt-read/latest.xpi";
          "{6d85dea2-0fb4-4de3-9f8c-264bce9a2296}".installation_mode = "force_installed";
          "{6d85dea2-0fb4-4de3-9f8c-264bce9a2296}".install_url =
            "https://addons.mozilla.org/en-US/firefox/downloads/latest/link-cleaner/latest.xpi";
          "{762f9885-5a13-4abd-9c77-433dcd38b8fd}".installation_mode = "force_installed";
          "{762f9885-5a13-4abd-9c77-433dcd38b8fd}".install_url =
            "https://addons.mozilla.org/en-US/firefox/downloads/latest/return-youtube-dislikes/latest.xpi";
          "{a4c4eda4-fb84-4a84-b4a1-f7c1cbf2a1ad}".installation_mode = "force_installed";
          "{a4c4eda4-fb84-4a84-b4a1-f7c1cbf2a1ad}".install_url =
            "https://addons.mozilla.org/en-US/firefox/downloads/latest/refined-github-/latest.xpi";
          "{c2c003ee-bd69-42a2-b0e9-6f34222cb046}".installation_mode = "force_installed";
          "{c2c003ee-bd69-42a2-b0e9-6f34222cb046}".install_url =
            "https://addons.mozilla.org/en-US/firefox/downloads/latest/auto-tab-discard/latest.xpi";
          "{cb31ec5d-c49a-4e5a-b240-16c767444f62}".installation_mode = "force_installed";
          "{cb31ec5d-c49a-4e5a-b240-16c767444f62}".install_url =
            "https://addons.mozilla.org/en-US/firefox/downloads/latest/indie-wiki-buddy/latest.xpi";
          "{eb8c4a94-e603-49ef-8e81-73d3c4cc04ff}".installation_mode = "force_installed";
          "{eb8c4a94-e603-49ef-8e81-73d3c4cc04ff}".install_url =
            "https://addons.mozilla.org/firefox/downloads/latest/gruvbox-dark-theme/latest.xpi";
        };
